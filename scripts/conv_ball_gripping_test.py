...
if __name__ == '__main__':
	...
	client = actionlib.SimpleActionClient('/irp6ot_arm/spline_trajectory_action_joint', FollowJointTrajectoryAction)
	...
	goal.trajectory.points.append(JointTrajectoryPoint([0, 0, -0.5 * math.pi, 0, 0, 1.45 * math.pi, -0.5 * math.pi], [], [], [], rospy.Duration(6.0)))
	...
	#=====================================================
	conManSwitch(['Irp6otmPoseInt'], ['Irp6otmSplineTrajectoryGeneratorJoint'], True)
